...
This recipe builds on native texture import (`importExternalTexture`) and worklet runtimes. If those are new to you, read [Native APIs](/docs/getting-started/native-api) and [Reanimated](/docs/integrations/reanimated) first, and see [Native Extensions](/api/gpu-device-extensions) for the full import API.
</Callout>
