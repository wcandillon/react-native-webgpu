...
To start from a preconfigured Expo project, create the [hosted WebGPU template](/docs/getting-started/expo) and choose **React Three Fiber** from its menu.
...
| **Worklets** | Keep `GPUDevice` on the main thread if combining with worklets ([Worklets](/docs/integrations/worklets)) |
