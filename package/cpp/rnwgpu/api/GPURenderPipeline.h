...
public:
    explicit GPURenderPipeline(wgpu::RenderPipeline instance, std::string label) : HybridObject("GPURenderPipeline"), _instance(instance), _label(label) {}
...
public:
  ...
  void loadHybridMethods() override {
    ...
    registerHybridMethod("getBindGroupLayout", &GPURenderPipeline::getBindGroupLayout, this);
    
    registerHybridGetter("label", &GPURenderPipeline::getLabel, this);
  }
  
  inline const wgpu::RenderPipeline get() {
    return _instance;
  }
