...
public:
    explicit GPUCommandBuffer(wgpu::CommandBuffer instance, std::string label) : HybridObject("GPUCommandBuffer"), _instance(instance), _label(label) {}
...
public:
  ...
  inline const wgpu::CommandBuffer get() {
    return _instance;
  }
