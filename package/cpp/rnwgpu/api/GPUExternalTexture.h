...
public:
    explicit GPUExternalTexture(wgpu::ExternalTexture instance, std::string label) : HybridObject("GPUExternalTexture"), _instance(instance), _label(label) {}
...
public:
  ...
  inline const wgpu::ExternalTexture get() {
    return _instance;
  }
