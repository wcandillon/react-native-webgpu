...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::AddressMode* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::AddressMode inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::BlendFactor* outEnum) { 
     if (inUnion == "zero") {
  ...
  static void convertEnumToJSUnion(wgpu::BlendFactor inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::BlendOperation* outEnum) { 
     if (inUnion == "add") {
  ...
  static void convertEnumToJSUnion(wgpu::BlendOperation inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::BufferBindingType* outEnum) { 
     if (inUnion == "uniform") {
  ...
  static void convertEnumToJSUnion(wgpu::BufferBindingType inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::BufferMapState* outEnum) { 
     if (inUnion == "unmapped") {
  ...
  static void convertEnumToJSUnion(wgpu::BufferMapState inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::CompareFunction* outEnum) { 
     if (inUnion == "never") {
  ...
  static void convertEnumToJSUnion(wgpu::CompareFunction inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::CompilationMessageType* outEnum) { 
     if (inUnion == "error") {
  ...
  static void convertEnumToJSUnion(wgpu::CompilationMessageType inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::CullMode* outEnum) { 
     if (inUnion == "none") {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::DeviceLostReason* outEnum) { 
     if (inUnion == "unknown") {
  ...
  static void convertEnumToJSUnion(wgpu::DeviceLostReason inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::ErrorFilter* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::ErrorFilter inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::FeatureName* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::FeatureName inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::FilterMode* outEnum) { 
     if (inUnion == "nearest") {
  ...
  static void convertEnumToJSUnion(wgpu::FilterMode inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::FrontFace* outEnum) { 
     if (inUnion == "ccw") {
  ...
  static void convertEnumToJSUnion(wgpu::FrontFace inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::IndexFormat* outEnum) { 
     if (inUnion == "uint16") {
  ...
  static void convertEnumToJSUnion(wgpu::IndexFormat inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::LoadOp* outEnum) { 
     if (inUnion == "load") {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::MipmapFilterMode* outEnum) { 
     if (inUnion == "nearest") {
  ...
  static void convertEnumToJSUnion(wgpu::MipmapFilterMode inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::PowerPreference* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::PowerPreference inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::PrimitiveTopology* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::PrimitiveTopology inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::QueryType* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::QueryType inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::SamplerBindingType* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::SamplerBindingType inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::StencilOperation* outEnum) { 
     if (inUnion == "zero") {
  ...
  static void convertEnumToJSUnion(wgpu::StencilOperation inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::StorageTextureAccess* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::StorageTextureAccess inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::StoreOp* outEnum) { 
     if (inUnion == "store") {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::TextureAspect* outEnum) { 
     if (inUnion == "all") {
  ...
  static void convertEnumToJSUnion(wgpu::TextureAspect inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::TextureDimension* outEnum) { 
     if (inUnion == "1d") {
  ...
  static void convertEnumToJSUnion(wgpu::TextureDimension inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::TextureFormat* outEnum) { 
  ...
  static void convertEnumToJSUnion(wgpu::TextureFormat inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::TextureSampleType* outEnum) { 
     if (inUnion == "float") {
  ...
  static void convertEnumToJSUnion(wgpu::TextureSampleType inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::TextureViewDimension* outEnum) { 
     if (inUnion == "1d") {
  ...
  static void convertEnumToJSUnion(wgpu::TextureViewDimension inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::VertexFormat* outEnum) { 
     if (inUnion == "uint32") {
  ...
  static void convertEnumToJSUnion(wgpu::VertexFormat inEnum, std::string* outUnion) {
    switch (inEnum) {
...
static void convertJSUnionToEnum(const std::string& inUnion, wgpu::VertexStepMode* outEnum) { 
     if (inUnion == "vertex") {
  ...
  static void convertEnumToJSUnion(wgpu::VertexStepMode inEnum, std::string* outUnion) {
    switch (inEnum) {
