...
public:
  double CopySrc() {
      return static_cast<double>(wgpu::TextureUsage::CopySrc);
    }
    double CopyDst() {
      return static_cast<double>(wgpu::TextureUsage::CopyDst);
    }
  ...
  void loadHybridMethods() override {
    ...
    registerHybridGetter("TEXTURE_BINDING", &GPUTextureUsage::TextureBinding, this);
    registerHybridGetter("STORAGE_BINDING", &GPUTextureUsage::StorageBinding, this);
    registerHybridGetter("RENDER_ATTACHMENT", &GPUTextureUsage::RenderAttachment, this);
  }
};
} // namespace rnwgpu