...
template <> struct JSIConverter<std::shared_ptr<wgpu::TextureViewDescriptor>> {
  static std::shared_ptr<wgpu::TextureViewDescriptor>
  fromJSI(jsi::Runtime &runtime, const jsi::Value &arg, bool outOfBounds) {
    auto result = std::make_unique<wgpu::TextureViewDescriptor>();
  ...
  static jsi::Value toJSI(jsi::Runtime &runtime,
                          std::shared_ptr<wgpu::TextureViewDescriptor> arg) {
    // No conversions here
