...
public:
    explicit GPUTexture(wgpu::Texture instance, std::string label) : HybridObject("GPUTexture"), _instance(instance), _label(label) {}

public:
  std::string getBrand() { return _name; }


  std::shared_ptr<GPUTextureView> createView(std::shared_ptr<GPUTextureViewDescriptor> descriptor);
void destroy();
...
registerHybridGetter("depthOrArrayLayers", &GPUTexture::getDepthOrArrayLayers, this);
