...
RNWebGPUManager::RNWebGPUManager(
  ...
  auto dispatcher = std::make_shared<margelo::nitro::CallInvokerDispatcher>(_jsCallInvoker);
  margelo::nitro::Dispatcher::installRuntimeGlobalDispatcher(*_jsRuntime, dispatcher);
