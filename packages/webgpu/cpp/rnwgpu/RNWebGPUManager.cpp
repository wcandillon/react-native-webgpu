...
RNWebGPUManager::RNWebGPUManager(
  ...
  auto dispatcher =
      std::make_shared<margelo::threading::CallInvokerDispatcher>(_jsCallInvoker);
  margelo::threading::Dispatcher::installRuntimeGlobalDispatcher(*_jsRuntime, dispatcher);
