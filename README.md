...
Starting from `r168`, we will be able to use the official version of Three.js on iOS.
There is an [an open PR](https://github.com/mrdoob/three.js/pull/29221) to make it work on Android out of the box as well.
